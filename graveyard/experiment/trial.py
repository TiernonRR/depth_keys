...
class Trial:
    ...
    def compute_3d_keypoints(self):
        ...
        save_dir = os.path.join(self.base_dir, self.trial_id, "_proc")
    ...
    def visualize(self, matplot_viz=True, overlay_viz=True, output_dir=None, filename="merged_keypoints.h5", max_frames_matplot=10000, **overlay_kwargs):
        """
